...
export function registerSessionCommands(
  ...
  resolveFile: (path: string, cwd?: string) => Promise<import("../types/chat").ContextAttachmentDTO>,
  resolveSelection: () => Promise<import("../types/chat").ContextAttachmentDTO | null>,
  resolveDiff: () => Promise<import("../types/chat").ContextAttachmentDTO | null>
): vscode.Disposable[] {
  // acp.newSession
