...
export function ResponsePreviewList({
  ...
  return (
    <div
      className={`flex flex-col gap-0.5 mt-[4px] pt-1 border-t border-border/40 ${className}`.trim()}
    >
      {items.map((r) => (
        <div
          key={r.messageId}
        ...
        >
          ...
          <span
            className="flex-1 min-w-0 overflow-hidden whitespace-nowrap truncate"
            title={r.preview}
          >
            {r.preview}
          </span>
