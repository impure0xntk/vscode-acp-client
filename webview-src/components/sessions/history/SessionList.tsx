...
function SessionRow({
  ...
  return (
    <div
      className={`group flex items-start gap-2 px-2.5 py-[6px] cursor-pointer transition-colors duration-100 hover:bg-accent-hover focus-visible:outline focus-visible:outline-1 focus-visible:outline-accent focus-visible:outline-offset-[-1px] ${
