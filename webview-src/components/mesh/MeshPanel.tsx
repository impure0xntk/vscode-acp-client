...
function TeamRow({
  ...
  return (
    <div className="rounded-[3px] overflow-hidden">
      <div
        className="flex items-center gap-1.5 py-[6px] px-2 cursor-pointer select-none hover:bg-accent-hover"
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex border-b border-border flex-shrink-0">
        <button
          className={`flex-1 py-[6px] px-2 border-none bg-transparent text-fg-muted text-[11px] cursor-pointer text-center hover:text-fg-secondary hover:bg-accent-hover ${activeTab === "teams" ? "text-fg-primary bg-bg-primary shadow-[inset_0_-2px_0_var(--accent)]" : ""}`}
        ...
        <button
          className={`flex-1 py-[6px] px-2 border-none bg-transparent text-fg-muted text-[11px] cursor-pointer text-center hover:text-fg-secondary hover:bg-accent-hover ${activeTab === "agents" ? "text-fg-primary bg-bg-primary shadow-[inset_0_-2px_0_var(--accent)]" : ""}`}
        ...
        <button
          className={`flex-1 py-[6px] px-2 border-none bg-transparent text-fg-muted text-[11px] cursor-pointer text-center hover:text-fg-secondary hover:bg-accent-hover ${activeTab === "tasks" ? "text-fg-primary bg-bg-primary shadow-[inset_0_-2px_0_var(--accent)]" : ""}`}
        ...
        <button
          className={`flex-1 py-[6px] px-2 border-none bg-transparent text-fg-muted text-[11px] cursor-pointer text-center hover:text-fg-secondary hover:bg-accent-hover ${activeTab === "messages" ? "text-fg-primary bg-bg-primary shadow-[inset_0_-2px_0_var(--accent)]" : ""}`}
