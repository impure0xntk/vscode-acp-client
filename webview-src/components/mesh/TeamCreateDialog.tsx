    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-end gap-2 px-4 py-3 border-t border-border flex-shrink-0">
          ...
          <button
            className="inline-flex items-center gap-1.5 py-[6px] px-4 border-none rounded-[4px] bg-accent text-user-fg text-[12px] font-medium cursor-pointer hover:bg-[color-mix(in_srgb,var(--accent)_80%,white)] disabled:opacity-50 disabled:cursor-not-allowed"
